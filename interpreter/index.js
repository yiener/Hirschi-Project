      ...
      try{
        switch(opCode){
            ...
            case MSTORE:
                ...
                this.state.memory[m2] = m1
                break
            case MLOAD:
                const m3 = this.state.stack.pop()
                this.state.stack.push(this.state.memory[m3])
                break
            case MSIZE:
