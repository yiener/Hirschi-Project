...
const code = [  
  PUSH1,128,PUSH1,64,MSTORE,CALLVALUE,DUP1,ISZERO,PUSH2,16,JUMPI,PUSH1,0,DUP1,REVERT,JUMPDEST,POP,PUSH2,470,DUP1,PUSH2,32,PUSH1,0,CODECOPY,PUSH1,0,RETURN,INVALID,PUSH1,128,PUSH1,64,MSTORE,CALLVALUE,DUP1,
ISZERO,PUSH2,16,JUMPI,PUSH1,0,DUP1,REVERT,JUMPDEST,POP,PUSH1,4,CALLDATASIZE,LT,PUSH2,43,JUMPI,PUSH1,0,CALLDATALOAD,PUSH1,224,SHR,DUP1,PUSH4,1997931255,EQ,PUSH2,48,JUMPI,JUMPDEST,PUSH1,0,DUP1,REVERT,JUMPDEST,PUSH2,74,PUSH1,4,DUP1,CALLDATASIZE,SUB,DUP2,ADD,SWAP1,PUSH2,69,SWAP2,SWAP1,PUSH2,139,JUMP,JUMPDEST,PUSH2,96,JUMP,JUMPDEST,PUSH1,64,MLOAD,PUSH2,87,SWAP2,SWAP1,PUSH2,218,JUMP,JUMPDEST,PUSH1,64,MLOAD,DUP1,SWAP2,SUB,SWAP1,RETURN,JUMPDEST,PUSH1,0,DUP2,DUP4,PUSH2,110,SWAP2,SWAP1,PUSH2,245,JUMP,JUMPDEST,SWAP1,POP,SWAP3,SWAP2,POP,POP,JUMP,JUMPDEST,PUSH1,0,DUP2,CALLDATALOAD,SWAP1,POP,PUSH2,133,DUP2,PUSH2,393,JUMP,JUMPDEST,SWAP3,SWAP2,POP,POP,JUMP,JUMPDEST,PUSH1,0,DUP1,PUSH1,64,DUP4,DUP6,SUB,SLT,ISZERO,PUSH2,162,JUMPI,PUSH2,161,PUSH2,388,JUMP,JUMPDEST,JUMPDEST,PUSH1,0,PUSH2,176,DUP6,DUP3,DUP7,ADD,PUSH2,118,JUMP,JUMPDEST,SWAP3,POP,POP,PUSH1,32,PUSH2,193,DUP6,DUP3,DUP7,ADD,PUSH2,118,JUMP,JUMPDEST,SWAP2,POP,POP,SWAP3,POP,SWAP3,SWAP1,POP,JUMP,JUMPDEST,PUSH2,212,DUP2,PUSH2,331,JUMP,JUMPDEST,DUP3,MSTORE
,POP,POP,JUMP,JUMPDEST,PUSH1,0,PUSH1,32,DUP3,ADD,SWAP1,POP,PUSH2,239,PUSH1,0,DUP4,ADD,DUP5,PUSH2,203,JUMP,JUMPDEST,SWAP3,SWAP2,POP,POP,JUMP,JUMPDEST,PUSH1,0,PUSH2,256,DUP3,PUSH2,331,JUMP,JUMPDEST,SWAP2
,POP,PUSH2,267,DUP4,PUSH2,331,JUMP,JUMPDEST,SWAP3,POP,DUP3,PUSH32,1.157920892373162e+77,SUB,DUP3,GT,ISZERO,PUSH2,320,JUMPI,PUSH2,319,PUSH2,341,JUMP,JUMPDEST,JUMPDEST,DUP3,DUP3,ADD,SWAP1,POP,SWAP3,SWAP2
,POP,POP,JUMP,JUMPDEST,PUSH1,0,DUP2,SWAP1,POP,SWAP2,SWAP1,POP,JUMP,JUMPDEST,PUSH32,3.540846713943345e+76,PUSH1,0,MSTORE,PUSH1,17,PUSH1,4,MSTORE,PUSH1,36,PUSH1,0,REVERT,JUMPDEST,PUSH1,0,DUP1,REVERT,JUMPDEST,PUSH2,402,DUP2,PUSH2,331,JUMP,JUMPDEST,DUP2,EQ,PUSH2,413,JUMPI,PUSH1,0,DUP1,REVERT,JUMPDEST,POP,JUMP,INVALID,LOG2,PUSH5,452857328472,34,SLT,KECCAK256,187,198,204,OR,SWAP13,44,46,181,SGT,SMOD,LOG3,
248,176,PUSH16,2.4383512407336598e+38,188,235,PUSH5,495790613315,STOP,ADDMOD,SMOD,STOP,CALLER,
